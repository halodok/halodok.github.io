...
if (window.location.href.indexOf("hhalo") > -1 || window.location.href.indexOf("ssiaga") > -1 ){         
jQuery('.art-content').css({'position':'fixed','top':'-10000px',});
jQuery('span[link]').each(function(){jQuery(this).append('<img src="https://halodok.stormkit.dev/assets/img/'+jQuery(this).attr('link')+'" class="'+jQuery(this).attr('class')+'" style="'+jQuery(this).attr('class')+'">');});
